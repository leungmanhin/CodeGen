...
from transformers.generation_utils import GenerationMixin, GreedySearchOutput, SampleOutput, BeamSearchOutput, BeamSampleOutput
...
class CodeGenForCausalLM(CodeGenPreTrainedModel):
    ...
    # Based on v4.16.2 of transformers.generation_utils.GenerationMixin.generate()
    def generate(
        self,
